 ...
 * SPLITINFINITIESL_Plugin_Activation class constructor.
 */
function tech_omaha_register_required_plugins() {
	/*
...
add_action( 'tgmpa_register', 'tech_omaha_register_required_plugins' );
